...
function toBuildPlan(discovery, overrides = {}) {
  ...
  const plan = {
    ...
    frameworkVersion: discovery.frameworkVersion || '',
    moduleFormat: discovery.moduleFormat || '',
    typescriptVersion: discovery.typescriptVersion || '',
    hasTsconfig: Boolean(discovery.hasTsconfig),
    tsconfigJsx: discovery.tsconfigJsx || '',
    tsconfigModule: discovery.tsconfigModule || '',
